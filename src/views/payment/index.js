            ...
            <nav className="relative w-full py-4 px-6 md:px-12 flex justify-between items-center bg-transparent z-10">
                ...
                <div className='flex flex-row justify-between px-4 py-3'>
                    <div className='flex flex-row gap-2'>
                        <button class="rounded-lg px-5 py-3 font-semibold">Information</button>
                        <button class="rounded-lg hover:text-lg bg-green-500 px-2.5 py-1.5 font-semibold">Payment</button>
                ...
                <div>
                    <div className='flex flex-col p-4 px-4'>
                        ...
                        <div className='flex flex-none py-2'>
                            <input 
                            type="text" 
                            placeholder="pranto.cse.20220104018@aust.edu" 
